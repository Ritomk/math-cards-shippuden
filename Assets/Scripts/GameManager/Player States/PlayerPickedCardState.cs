...
{
    public class PlayerPickedCardState : PlayerStateBase
    {
        ...
        public PlayerPickedCardState(StateMachine<PlayerStateEnum> stateMachine, CardHighlightController cardHighlightController) : base(stateMachine)
        {
